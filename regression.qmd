...
![lines drawn to show functional relationship between soil moisture and yield](images/r99.png){#fig-funcrel fig-align="center" width="50%" style="text-align:center;"}
...
In essence, a residual serves as an estimate of the error. While errors represent the deviation from the actual true value, residuals reflect the discrepancy between observed data and the fitted model. From @fig-residual you can see the residual in a fitted regression line.  
