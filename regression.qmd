...
![Perfect negative correlation](images/perfect_negative.png){#fig-nocorrel width="200px" height="150px"}  
![High degree positive correlation](images/highdegree_positive.png){#fig-nocorrel width="200px" height="150px"}  
![High degree negative correlation](images/highdegree_negative.png){#fig-nocorrel width="200px" height="150px"} 
![Low degree negative correlation](images/lowdegree_negative.png){#fig-nocorrel width="200px" height="150px"}  
![Low degree positive correlation](images/lowdegree_positive.png){#fig-nocorrel width="200px" height="150px"}  
