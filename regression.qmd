...
$$=\frac{\partial E}{\partial \alpha} = -2 \sum_{i=1}^n \left[ y_i - \alpha - \beta x_i \right]$$ {#eq-lssquares2}
...
$$=\frac{\partial E}{\partial \beta} = -2 \sum_{i=1}^n x_i \left[ y_i - \alpha - \beta x_i \right]$$ {#eq-lssquares6}
...
Consider the data presented in @tbl-corrdata, which shows the average daily soil moisture content and the corresponding monetary yield from crops in Example 8.2 of @sec-scatterdiag. Where we can draw two lines of regression interchanging variables in X and Y axis as shown in @fig-twolines.  

::: {#fig-twolines layout-ncol="2"}
![Soil moisture in X-axis and crop yield in Y-axis](images/yonx.png){#fig-intercept width="200px" height="150px"}

![Crop yield in X-axis and soil moisture in Y-axis](images/yonx.png){#fig-intercept width="200px" height="150px"}
