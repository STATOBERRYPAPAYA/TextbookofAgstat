...
![Soil moisture in X-axis and crop yield in Y-axis](images/yonx.png){width="200px" height="150px"}

![Crop yield in X-axis and soil moisture in Y-axis](images/yonx.png){width="200px" height="150px"}
...
$$var\left( x \right) = \ \frac{1}{n}\sum_{i = 1}^{n}\left( x_{i} - \overline{x} \right)^{2} = \frac{176.983}{12} = 14.7485$$
now using @eq-regeqn4  
