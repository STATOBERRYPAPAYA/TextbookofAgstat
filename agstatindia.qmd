...
Once the field is selected, the experimental plot is located and marked starting from the south-west (SW) corner of the field. This is a standard rule followed everywhere, so that the plot is marked in a uniform way and can be inspected later by supervisors with ease.

The size and shape of the CCE plot differ slightly from state to state and crop to crop. In most states, the plot is either a square of size 5 m × 5 m or 10 m × 10 m, or a rectangle of size 10 m × 5 m. In Uttar Pradesh, the plot is shaped as an equilateral triangle (all three sides equal) with each side measuring 10 m, for most crops. In West Bengal, the plot is a circle of radius 1.7145 m, approximately.

![Demarcation of a 5 m × 5 m CCE plot from the SW corner of the field](images/cceplot.png){#fig-cceplot fig-alt="Demarcation of CCE plot of 5 m by 5 m size from SW corner" fig-align="center" width="70%" style="text-align:center;"}

@fig-cceplot shows a 5 m × 5 m plot marked at 58 steps and 51 steps from the SW corner of a field measuring 120 steps by 70 steps. The diagonal $AC = BD = \sqrt{5^2+5^2} = 7.07$ m, which is used to check that the marked plot is a true square.
...
1. Area sown; Average yield
2. Concurrent
3. State Agricultural Statistics Authorities (SASAs)
4. Directorate of Economics and Statistics (DES)
5. Area sown; Average yield
6. Land revenue; Crop estimation surveys
7. 86
8. 9
9. 5
10. Crop Cutting Experiments (CCE)
11. 65
12. 51; 14
13. 9
14. South-west (SW)
...
26. December
27. 1970-71
28. Quinquennial (five-yearly)
29. July; June
30. Complete
31. Sample
32. Eleven; 2020-21
33. Indian Statistical Institute (ISI)
34. National Sample Survey
