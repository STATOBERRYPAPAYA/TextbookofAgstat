...
Let's find Bowley’s measure of skewness for @tbl-skewnessmodel in Example 7.1. From the cumulative frequency in @tbl-karlcf, the quartiles can be calculated. Calculation of ${Q}_{1}$, $Q_{2}$, $Q_{3}$ is given in @sec-quartile.
