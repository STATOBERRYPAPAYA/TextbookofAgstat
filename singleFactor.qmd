...
are presented for a given standard order of alphabets in the first row, illustrated in @fig-stdlattice. Choose one of 
these squares for a given $v$ and carryout the randomization as explained below.  
![](images/singlefactor/stdlatin.svg){#fig-stdlattice width="250px" height="500px"}

Let $v$ = 6. Then a Latin Square of 6 treatments, where treatments are denoted by *A*, *B*, *C*, *D*, *E* and *F* 
