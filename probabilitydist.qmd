...
$p(X=6)=\binom{10}{6}\left( \frac{1}{2} \right)^{6}\left( \frac{1}{2} \right)^{10 - 6} = 210 \times \left( \frac{1}{2} \right)^{10} = 0.2050$
:::
...
| Number surviving ($x$) | 0   | 1   | 2   | 3   | 4   | 5   |
|:-----------------------|:----|:----|:----|:----|:----|:----|
| Number of groups       | 3   | 16  | 32  | 28  | 17  | 4   |
...
| Number of larvae ($x$) | 0   | 1   | 2   | 3   | 4 or more |
|:-----------------------|:----|:----|:----|:----|:----------|
| Number of plants       | 37  | 37  | 18  | 6   | 2         |
...
![Shape changes in normal distribution based on different means](images/normal6.png){#fig-normalchange fig-align="center" style="text-align:center;" width="80%"}
...
![Shape changes in normal distribution based on different standard deviation](images/normal7.png){#fig-normalchange2 fig-align="center" style="text-align:center;" width="80%"}
...
![Normal distribution curve](images/normal1.png){#fig-normalcurve fig-align="center" style="text-align:center;" width="80%"}

2.  The Normal Distribution has mean = median = mode. Mean, median and mode is located to the center of the curve.

![Mean=Median=Mode in normal distribution](images/normal2.png){#fig-normalcurve2 fig-align="center" style="text-align:center;" width="80%"}

3.  Normal distribution is symmetric about the center, 50% of values less than the mean and 50% greater than the mean

![Normal distribution is a symmetric distribution](images/normal3.png){#fig-normalsymmetry fig-align="center" style="text-align:center;" width="80%"}
...
![Area property of normal distribution](images/normal8.png){#fig-areaproperty fig-align="center" style="text-align:center;" width="80%"}
...
![Standardization of normal distribution](images/normal4.png){#fig-normalstandardize fig-align="center" style="text-align:center;" width="80%"}
...
![Z score values of X for @exm-zscore1](images/normal5.png){#fig-zscoreandx fig-align="center" style="text-align:center;" width="80%"}
:::
...
![Z-score table](images/ztable.png){#fig-zscoretable fig-align="center" style="text-align:center; height:80%;" width="60%"}
...
::: {#exm-zscore3}
Average yield of mango trees in an orchard has a mean of 70kg and with a standard deviation of 12kg. What is the probable percentage of mango trees with yield more than 85kg?

**Solution**

The z score for the given data using @eq-standard is $z = \frac{85 - 70}{12}=1.25$. From the z score table @fig-zscoretable, the fraction of the data within this score is 0.8944. This means 89.44 % of the trees are within the yield of 85kg and hence the percentage of trees with yield above 85kg = (100-89.44)% = 10.56 %.
:::
