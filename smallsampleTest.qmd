...
kable(dt, escape = FALSE, caption = "Calculation of sample mean and standard deviation") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling(position = "center", bootstrap_options = c("striped")) %>%
  row_spec(0, bold = TRUE, align = "c") %>%
  column_spec(1:4, width = "4cm", extra_css = "text-align: center;")
```
...
$$t = \frac{\overline{x}_1 - \overline{x}_2}{s \sqrt{\dfrac{1}{n_1} + \dfrac{1}{n_2}}}$$
...
$$\text{df} = \frac{\left( \dfrac{s_1^2}{n_1} + \dfrac{s_2^2}{n_2} \right)^2}{\dfrac{s_1^4}{n_1^2 (n_1 - 1)} + \dfrac{s_2^4}{n_2^2 (n_2 - 1)}}$$
...
kable(dt, escape = FALSE, caption = "Calculation of paired differences") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling(position = "center", bootstrap_options = c("striped")) %>%
  row_spec(0, bold = TRUE, align = "c") %>%
  column_spec(1:6, width = "2cm", extra_css = "text-align: center;")
```
...
kable(dt, escape = FALSE, caption = "Calculation of chi-square for goodness of fit") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling(position = "center", bootstrap_options = c("striped")) %>%
  row_spec(0, bold = TRUE, align = "c") %>%
  column_spec(1:6, width = "3cm", extra_css = "text-align: center;")
```

$$\chi^2 = \sum_{i=1}^{n} \frac{\left( O_i - E_i \right)^2}{E_i} = 0.676$$

$\chi^2_{\text{cal}}$ = 0.676. The table value of chi-square for $4 - 1 = 3$ degrees of freedom at the 5% level of significance is 7.815. Since the calculated value is less than the table value, we do not reject the null hypothesis. We conclude that the data agree with the 9:3:3:1 ratio.
:::
...
kable(dt, escape = FALSE, caption = "Contingency table for germination of cotton seeds") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling(position = "center", bootstrap_options = c("striped")) %>%
  row_spec(0, bold = TRUE, align = "c") %>%
  column_spec(1:5, width = "4cm", extra_css = "text-align: center;")
```
...
kable(dt, escape = FALSE, caption = "General form of an r x s contingency table") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling(position = "center", bootstrap_options = c("striped")) %>%
  row_spec(0, bold = TRUE, align = "c") %>%
  column_spec(1:6, width = "4cm", extra_css = "text-align: center;")
```
...
$$\chi^2 = \sum_{i=1}^{r} \sum_{j=1}^{s} \frac{\left( O_{ij} - E_{ij} \right)^2}{E_{ij}}$$
...
The expected value $E_{ij}$ for each cell is calculated by multiplying the corresponding row total and column total and dividing by the grand total. The calculation of the chi-square statistic is shown in @tbl-conting2calc.

```{r ex81, echo=FALSE, warning=FALSE, results='asis'}
library(knitr)
library(kableExtra)
dt <- read.csv("csv/Book18.csv")
kable(dt, escape = FALSE, caption = "Expected frequencies for the tenure and fertility data") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling(position = "center", bootstrap_options = c("striped")) %>%
  row_spec(0, bold = TRUE, align = "c") %>%
  column_spec(1:4, width = "4cm", extra_css = "text-align: center;")
...
kable(dt, escape = FALSE, caption = "Calculation of chi-square for independence of attributes") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling(position = "center", bootstrap_options = c("striped")) %>%
  row_spec(0, bold = TRUE, align = "c") %>%
  column_spec(1:5, width = "4cm", extra_css = "text-align: center;")
...
$$\chi^2 = \frac{n\left( ad - bc \right)^2}{C_1 C_2 R_1 R_2}$$
...
$$\chi^2 = \frac{n\left( \left| ad - bc \right| - \dfrac{n}{2} \right)^2}{C_1 C_2 R_1 R_2}$$
...
```{r ttable, echo=FALSE, fig.cap='Student t distribution table', out.width="85%", fig.align='center'}
#| label: fig-ttable
