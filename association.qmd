...
|  |  |  |  |  |  |  |  |
|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|
| Sl. No. | Temperature (x) | Sales (y) | $x_{i}-\overline{x}$(1) | $y_{i}-\overline{y}$(2) | (1).(2) | $(x_{i}-\overline{x})^{2}$ | $(y_{i}-\overline{y})^{2}$ |
...
: Tied rank case calculation table1 {#tbl-tiedcalc1 .bordered}
...
: Tied rank case calculation table2 {#tbl-tiedcalc2 .bordered}
...
: Tied rank case calculation table3 {#tbl-tiedcalc3 .bordered}
...
: Tied rank case calculation table4 {#tbl-tiedcalc4 .bordered}

**Step 2**: Calculate T\_{x} and T\_{y}
...
: Tied rank case calculation table5 {#tbl-tiedcalc5 .bordered}
