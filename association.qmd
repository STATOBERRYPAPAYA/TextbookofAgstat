...
Correlation is a statistical method used to analyze the relationship between two or more variables. The correlation measures the degree and closeness of the linear relationship between two variables in numerical magnitude.
...
In [simple correlation]{.underline} the relationship is confined to two variables only. In [multiple correlation]{.underline} the relationship between more than two variables is judged.
...
Under [partial correlation]{.underline} the relationship of two or variables is examined after eliminating the linear effect of other correlated variables.
