...
We begin by exploring the origins and definitions of statistics, emphasizing its relationship with mathematics and its distinct role in solving real-world problems. Further, we focus on the importance of data (the raw material of statistics), examining its types and how it is collected, organized, and analyzed.
...
**Descriptive statistics**, which deals with summarizing data from a sample using indexes or measures such as the mean or standard deviation etc.
...
In this study, we are interested in the height of all students in the college. The set of all students height in the college is called the **population** of this study. The set of 20 students height, *H* = {149, 156, 148, ..., 153, 159}, is a **sample** from this population.
...
A *population parameter* is a numerical characteristic or a value that describes an aspect of an entire population. It is a fixed (constant), often unknown value that represents the true measurement of a specific attribute for every member of the population. Common population parameters include the population mean, population variance, and population proportion. Since it is usually impractical or impossible to measure the entire population, parameters are often estimated using sample data.
...
![Classification of variables](images/intro/variables.svg){#fig-classvariable out-width="100%" fig-alt="Classification of variables" fig-align="center" style="text-align:center;"}
...
Data is gathered by contacting individuals via telephone/mobile phone/mail. This method is fast and allows for accurate information to be collected efficiently, making it suitable for studies that require a broad reach but still need reliable data.
...
![Frequency distribution table](images/intro/fig1.4.svg){fig-alt="Frequency distribution table" fig-align="center" out-width="100%" style="text-align:center;"}
...
It can be seen that the minimum and the maximum plant height are 107 cm and 144 cm, respectively. A frequency distribution giving each of the plant height between 107 cm and 144 cm would be very long and would not be very informative. This problem can be addressed by grouping the data into class intervals.\
...
![Grouped Frequency distribution table](images/intro/fig1.6.svg){fig-alt="Grouped Frequency distribution table" fig-align="center" out-width="100%" style="text-align:center;"}
...
![Class boundary and class limits](images/intro/fig1.7.svg){fig-alt="Class boundary and class limits" fig-align="center" out-width="100%" style="text-align:center;"}
...
H.A. Sturges provides a formula for determining the approximate number of classes. $$\mathbf{k = 1 + 3.322}.\mathbf{\log}\mathbf{N}$$ Number of classes should be greater than calculated *k*.\
...
where, *C'* and *k'* here are final approximated class width and number of classes respectively in our example, $L = 1 - \frac{(3 \times 7) - (18 - 1)}{2}$ = 1-2 = -1; since there is no negative values in data, $L = 0$. Final frequency table will be as shown in @tbl-freq
...
1. The science of collecting, organizing, presenting, analyzing, and interpreting data is called __________.

2. The two main branches of statistics are __________ and __________.

3. The Father of Modern Statistics is __________.

4. The complete collection of individuals or observations under study is called the __________.

5. A subset of a population selected for study is called a __________.

6. A numerical characteristic of a population is called a population __________.

7. A characteristic that can take different values is called a __________.

8. A variable that takes countable values is called a __________ variable.

9. A variable that can take any value within a given range is called a __________ variable.

10. A variable that classifies observations into distinct categories is called a __________ variable.

11. The four levels of measurement are __________, __________, __________, and __________.

12. The measurement scale in which categories have no inherent order is the __________ scale.

13. The measurement scale in which categories have an order but differences are not necessarily uniform is the __________ scale.

14. The interval scale does not have a true __________ point.

15. The ratio scale has a meaningful __________ point.

16. Data collected first-hand for a specific purpose are called __________ data.

17. Data obtained from existing sources are called __________ data.

18. Data in their original form are called __________ data.

19. The number of times an observation occurs is called its __________.

20. The midpoint of a class interval is called the __________.

21. The values used to remove gaps between discontinuous classes are called class __________.

22. The running total of frequencies is called __________ frequency.

23. LCF stands for __________ cumulative frequency.

24. GCF stands for __________ cumulative frequency.

25. The proportion of observations belonging to a class is called __________ frequency.

26. Sturges' formula is used to determine the approximate number of __________.

27. The sum of all frequencies in a frequency distribution is equal to __________.

28. The sum of all relative frequencies is equal to __________.
...
`1.` Statistics `2.` Descriptive; Inferential `3.` Sir Ronald A. Fisher (R.A. Fisher) `4.` Population `5.` Sample `6.` Parameter `7.` Variable `8.` Discrete `9.` Continuous `10.` Categorical `11.` Nominal; Ordinal; Interval; Ratio `12.` Nominal `13.` Ordinal `14.` Zero `15.` Zero `16.` Primary `17.` Secondary `18.` Raw `19.` Frequency `20.` Class mark `21.` Boundaries `22.` Cumulative `23.` Less than `24.` Greater than `25.` Relative `26.` Classes `27.` $(N)$ `28.` 1
:::
