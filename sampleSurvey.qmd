...
```{r stratified, echo=FALSE, fig.cap='Illustration of stratified random sampling. The population is divided into non-overlapping strata, and independent random samples are selected from each stratum to form the final sample.', out.width="100%", fig.align='center'}
