...
19. Sampling error is the difference between estimkate and true population value. It can be calculated as $=38-40=-2$, so the estimate is 2 units below the population value.
