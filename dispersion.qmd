...
![Dot plot of datasets A & B](images/dispersion/dispersion1.svg){#fig-scatterab fig-align="center" width="50%" style="text-align:center;"}
...
1. The extent to which observations deviate from a central value is called __________.

2. The statistical measures used to quantify the spread or variability of data are called measures of __________.

3. The simplest measure of dispersion is the __________.

4. The range is the difference between the __________ observation and the __________ observation.

5. The range is denoted by __________.

6. For a grouped frequency distribution, the largest value for calculating range is taken as the __________ boundary of the highest class.

7. For a grouped frequency distribution, the smallest value for calculating range is taken as the __________ boundary of the lowest class.

8. The interquartile range is the difference between the __________ and __________ quartiles.

9. The interquartile range is also known as the __________.

10. The interquartile range is not affected by observations outside __________ and __________.

11. The mean absolute deviation is also known as the __________ deviation.

12. Mean absolute deviation is calculated by taking the average of the __________ deviations from a central value.

13. The most important measures of variability are variance and __________.

14. Sample variance is denoted by __________.

15. Sample standard deviation is denoted by __________.

16. Standard deviation is the positive __________ root of variance.

17. Variance is expressed in __________ units of the original measurements.

18. Standard deviation is expressed in the __________ units as the original measurements.

19. The standard deviation of a dataset can never be __________.

20. A larger standard deviation indicates __________ dispersion of observations around the mean.

21. A smaller standard deviation indicates __________ dispersion of observations around the mean.

22. The relative measure of dispersion used to compare variability between datasets is called the coefficient of __________.

23. The coefficient of variation is expressed as a __________.

24. A higher coefficient of variation indicates __________ relative variability.

25. A lower coefficient of variation indicates __________ relative variability.

26. The standard deviation is an __________ measure of dispersion.

27. The coefficient of variation is a __________ measure of dispersion.

28. The term “standard deviation” was first introduced in writing by __________ in 1894.

29. The concept of variance was introduced by __________.

30. The mean absolute deviation about the __________ is the least.
...
1. Dispersion · 2. Dispersion · 3. Range · 4. Largest; smallest · 5. $R$ · 6. Upper · 7. Lower · 8. Third (upper); first (lower) · 9. Midspread · 10. $Q_1$; $Q_3$ · 11. Mean · 12. Absolute · 13. Standard deviation · 14. $s^2$ · 15. $s$ · 16. Square · 17. Squared · 18. Same · 19. Negative · 20. Greater · 21. Lower · 22. Variation · 23. Percentage · 24. Greater · 25. Lower · 26. Absolute · 27. Relative · 28. Karl Pearson · 29. R.A. Fisher · 30. Median  
...
3.  Using @eq-range with class boundaries, $R=L-S=75-60=15$.
...
11. Using @eq-sdgrp with $A=5$, $c=1$, $\sum f_id_i=21$, $\sum f_id_i^2=77$: $s^2=\frac{1}{49}\left(77-\frac{21^2}{50}\right)=1.3914$, so $s=1.18$, matching question 10 since $c=1$ leaves the variance unchanged.
